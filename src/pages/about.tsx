...
import { AboutBackground } from '../assets/index';
import { AboutCardContext } from '../contexts/aboutCard.context';
import { SmileyIcon } from '../assets/icons/index';
const About = () => {
   ...
   return (<>
      <section className='relative w-full h-[80vh] md:h-screen flex text-text'>
         <div className="max-w-layout mx-auto">
            ...
            <img src={AboutBackground} alt="About section background image" className='absolute inset-0 z-0 h-full w-full object-cover' loading='lazy' />
                  ...
                  aboutCardData.map((card: any, index: number) => (
                     <div key={index} className="bg-overlay p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <div className="flex items-center justify-center mb-4">
                           <img src={SmileyIcon} alt='smiley icon' loading='lazy' />
                        </div>
