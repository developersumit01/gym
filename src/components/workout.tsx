      ...
      <>
         <section className="max-w-layout mx-auto mt-16 text-text pt-12">
            ...
            <div className="grid grid-cols-1 pad:grid-cols-[400px_calc(100%-440px)] gap-8 px-4 sm:px-8 pad:px-0">
               <div className="grid grid-cols-[250px_1fr] pad:block gap-8">
               ...
               <div className="flex flex-col gap-8">
                  ...
                  <div className="px-5 py-4 bg-overlay rounded-2xl">
                     ...
                     >
                        {
                           workoutData.workout.map((program: any) => (
                              <SwiperSlide key={program.id} style={{ width: '56px' }}>
                                 <div className="w-14 h-12 text-nowrap cursor-pointer bg-text text-authText flex justify-center items-center rounded-xl font-semibold">
                                    Day 1
                                 </div>
                              </SwiperSlide>
                           ))
                  ...
                  <div className="basis-full px-8 py-6 bg-overlay rounded-2xl relative flex justify-between flex-col gap-4">
                     <div className="absolute h-[calc(100%-115px)] w-[1px] bg-white flex flex-col justify-between items-center top-1/2 bottom-1/2 -translate-y-1/2">
                        {
                           workoutData.workout[ 1 ].map((ele: any) => <div className="h-8 w-8 rounded-full flex justify-center items-center bg-darkBackground"><span className="h-5 w-5 rounded-full bg-white inline-block"></span></div>)
                        }
                     </div>
                     {
                        workoutData.workout[ 1 ].map((ele: any) => {
